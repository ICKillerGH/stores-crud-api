...
Route::prefix('/stores')->name('stores.')->group(function () {
    ...
    Route::post('/', [StoresController::class, 'store'])->name('store')->middleware('auth:api');
    Route::get('/{store}', [StoresController::class, 'show'])->name('show');
    Route::put('/{store}', [StoresController::class, 'update'])->name('update')->middleware('auth:api');
    Route::delete('/{store}', [StoresController::class, 'destroy'])->name('destroy')->middleware('auth:api');
});
